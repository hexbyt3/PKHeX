...
public static partial class Extensions
{
    ...
    /// </summary>
    public static bool GetIsValid(this IGeoTrack g) => g.GetValidity().Result == GeoValid.Valid;

    /// <summary>
    /// Checks if all Geolocation tuples are valid.
    /// </summary>
    internal static (GeoValid Result, byte Index) GetValidity(this IGeoTrack g)
    {
