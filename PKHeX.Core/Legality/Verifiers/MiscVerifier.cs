...
public sealed class MiscVerifier : Verifier
{
    ...
    private static void VerifyAbsoluteSizes<T>(LegalityAnalysis data, T obj) where T : IScaledSizeValue
    {
        ...
        else if (obj is PA8 pa8)
            VerifyAbsoluteSizes8a(data, pa8);
        else
    ...
    private static void VerifyAbsoluteSizes8a(LegalityAnalysis data, PA8 pk)
    {
    ...
    private static bool IsAbsoluteEdgeCase8a(LegalityAnalysis data, PA8 pk)
    {
        var enc = data.EncounterMatch;
    ...
    private static bool IsMatchCurrent8a(PA8 pk) => IsMatchCurrent8a(pk, pk.PersonalInfo);
    ...
    private static bool IsMatchCurrent8a(PA8 pk, PersonalInfo8LA pi)
    {
